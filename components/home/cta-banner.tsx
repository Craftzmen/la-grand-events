        ...
        <div className="relative overflow-hidden bg-navy p-12 text-center md:p-20 text-white">
          ...
          <div className="relative z-10">
            <h2 className="text-3xl font-extrabold md:text-5xl mb-6 font-serif">
              Start Planning Your <span className="text-amber italic font-light">Grand Event</span>
            </h2>
            <p className="mx-auto max-w-xl text-lg text-white/70 mb-10 font-light">
              Connect with our lead coordinators to schedule a private consultation and bring your distinct vision to life.
            </p>
            <div className="flex flex-wrap justify-center gap-4">
              ...
              >
                <Link href="/services">Explore Portfolio</Link>
              </Button>
            </div>
          </div>
        </div>
